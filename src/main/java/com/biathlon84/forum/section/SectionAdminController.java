...
import com.biathlon84.forum.model.ForumModelMapper;
import com.biathlon84.forum.model.dto.NewSectionForm;
import com.biathlon84.forum.model.dto.SectionDto;
...
public class SectionAdminController {
    ...
    public String processAndAddNewSection(@Valid @ModelAttribute("newSection") NewSectionForm newSection,
        ...
        System.out.println("post /a/sections/create");
...
//        }
    ...
    public String getSectionDetails(@PathVariable int id, Authentication authentication, RedirectAttributes model) {
